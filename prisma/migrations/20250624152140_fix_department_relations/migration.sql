...
INSERT INTO "new_User" ("address", "birth_date", "created_at", "deleted_at", "department_id", "email", "employment_type", "first_name", "gender", "hire_date", "id", "job_title", "last_name", "national_id", "password", "phone_number", "photo", "role", "salaire_brut", "status", "updated_at") SELECT "address", "birth_date", "created_at", "deleted_at", "department_id", "email", "employment_type", "first_name", "gender", "hire_date", "id", "job_title", "last_name", "national_id", "password", "phone_number", "photo", "role", "salaire_brut", "status", "updated_at" FROM "User";
DROP TABLE "User";
